...
public class kManager {
	...
	public PermissionManager getPermissionManager(){
		if(this.permissionManager==null)this.permissionManager=new PermissionManager(getInstance(),null);
	...
	public StatsManager getMoney(){
		if(this.money==null)this.money=new StatsManager(getInstance(), UtilServer.getClient(), GameType.Money);
		return this.money;
	}
