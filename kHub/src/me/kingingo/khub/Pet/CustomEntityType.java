...
import me.kingingo.khub.Pet.RideEntity.RideEnderman;
import me.kingingo.khub.Pet.RideEntity.RideIronGolem;
import me.kingingo.khub.Pet.RideEntity.RidePig;
import me.kingingo.khub.Pet.RideEntity.RideSheep;
import me.kingingo.khub.Pet.RideEntity.RideSpider;
import me.kingingo.khub.Pet.RideEntity.RideWolf;
...
PIG("Pig", 90, EntityType.PIG, EntityPig.class, RidePig.class),
WOLF("Wolf", 95, EntityType.WOLF, EntityWolf.class, RideWolf.class),
COW("Cow", 92, EntityType.COW, EntityCow.class, RideCow.class),
CHICKEN("Chicken", 93, EntityType.CHICKEN, EntityChicken.class, RideChicken.class),
ENDERMAN("Enderman", 58, EntityType.ENDERMAN, EntityEnderman.class, RideEnderman.class),
IRON_GOLEM("VillagerGolem", 99, EntityType.IRON_GOLEM, EntityIronGolem.class, RideIronGolem.class),
BLAZE("Blaze", 61, EntityType.BLAZE, EntityBlaze.class, RideBlaze.class),
SHEEP("Sheep", 91, EntityType.SHEEP, EntitySheep.class, RideSheep.class),
ZOMBIE("Zombie",54,EntityType.ZOMBIE,EntityZombie.class,RideZombie.class),
SPIDER("SPIDER", 52, EntityType.SPIDER, EntitySpider.class, RideSpider.class);
