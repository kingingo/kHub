...
public class PetPig implements Listener,PetInterface {

	private HashMap<Player,RideInterface> sheeps = new HashMap<>();
	private RidePig e =null;
    ...
    public PetPig(PetManager manager) {
	...
	public void remove(Player p) {
		sh=(Pig)sheeps.get(p).getBukkitEntity();
		sh.remove();
	}
    ...
    public void AddPlayer(Player p){
    	...
    	final RidePig rp = new RidePig(cw.getHandle());
    ...
    public Inventory getOptionInv(){
    	if(OptionInv == null){
    		OptionInv=Bukkit.createInventory(null, 9,"§aPet: Pig");
    		OptionInv.setItem(0, UtilItem.RenameItem(new ItemStack(383,1,(byte)90), "§aPet: Pig"));
    ...
    public Inventory getBuyInv(){
    	if(BuyInv == null){
    		BuyInv=Bukkit.createInventory(null, 9,"§aPet: Pig");
    		BuyInv.setItem(0, UtilItem.RenameItem(new ItemStack(383,1,(byte)90), "§aPet: Pig"));
    ...
    public Inventory getCointInv(){
    	if(CointInv == null){
    		CointInv=Bukkit.createInventory(null, 9,"§aPet: Pig");
    ...
    public Inventory getSelectInv(){
    	if(SelectInv == null){
    		SelectInv=Bukkit.createInventory(null, 9,"§aPet: Pig");
    		SelectInv.setItem(0, UtilItem.RenameItem(new ItemStack(383,1,(byte)90), "§aPet: Pig"));
    ...
    public void Inv(InventoryClickEvent ev){
		...
		if(!ev.getClickedInventory().getTitle().equalsIgnoreCase("§aPet: Pig"))return;
	...
	public ItemStack getIcon() {
		return UtilItem.Item(new ItemStack(383,1,(byte)90), desc, "§a"+getName());
	}
