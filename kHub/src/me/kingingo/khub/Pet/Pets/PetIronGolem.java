...
import me.kingingo.khub.Pet.RideEntity.RideIronGolem;
...
public class PetIronGolem implements Listener,PetInterface {

	private HashMap<Player,RideInterface> sheeps = new HashMap<>();
	private RideIronGolem e =null;
    ...
    public PetIronGolem(PetManager manager) {
	...
	public Permission getPermission() {
		return Permission.PET_IRON_GOLEM;
	}
	...
	public void remove(Player p) {
    	sh=(IronGolem)sheeps.get(p).getBukkitEntity();
    	sh.remove();
	}
    ...
    public void AddPlayer(Player p){
    	...
    	final RideIronGolem rp = new RideIronGolem(cw.getHandle());
    ...
    public Inventory getOptionInv(){
    	if(OptionInv == null){
    		OptionInv=Bukkit.createInventory(null, 9,"§aPet: IronGolem");
    		OptionInv.setItem(0, UtilItem.RenameItem(new ItemStack(383,1,(byte)56), "§aPet: IronGolem"));
    ...
    public Inventory getBuyInv(){
    	if(BuyInv == null){
    		BuyInv=Bukkit.createInventory(null, 9,"§aPet: IronGolem");
    		BuyInv.setItem(0, UtilItem.RenameItem(new ItemStack(383,1,(byte)56), "§aPet: IronGolem"));
    ...
    public Inventory getCointInv(){
    	if(CointInv == null){
    		CointInv=Bukkit.createInventory(null, 9,"§aPet: IronGolem");
    ...
    public Inventory getSelectInv(){
    	if(SelectInv == null){
    		SelectInv=Bukkit.createInventory(null, 9,"§aPet: IronGolem");
    		SelectInv.setItem(0, UtilItem.RenameItem(new ItemStack(383,1,(byte)56), "§aPet: IronGolem"));
    ...
    public void Join(String[] i,Player pl){
    	p=pl;
    	CraftWorld cw = (CraftWorld)p.getWorld();
		e = new RideIronGolem(cw.getHandle());
    	...
    	sheeps.put(p, e);
    	sh=(IronGolem)e.getBukkitEntity();
...
//    	}
    ...
    public void Inv(InventoryClickEvent ev){
		...
		if(!ev.getClickedInventory().getTitle().equalsIgnoreCase("§aPet: IronGolem"))return;
	...
	public ItemStack getIcon() {
		return UtilItem.Item(new ItemStack(383,1,(byte)56), desc, "§a"+getName());
	}
